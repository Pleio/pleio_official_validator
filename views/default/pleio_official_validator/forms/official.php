...
if(empty($validated)){
	if(empty($email)){
		...
		$pending_formbody .= "<div id='pleio_official_validator_official_pending'>";
		...
		$pending_formbody .= elgg_view("input/button", array("value" => elgg_echo("pleio_official_validator:official:forms:pending:revalidate"), "js" => "onclick='pleio_official_validator_official_revalidate();'"));
		$pending_formbody .= "&nbsp;";
		$pending_formbody .= elgg_view("input/button", array("value" => elgg_echo("pleio_official_validator:official:forms:pending:change"), "js" => "onclick='pleio_official_validator_official_change();'"));
		$pending_formbody .= "</div>";
